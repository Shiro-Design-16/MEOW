...
pub static APP_ID: &str = "io.github.shiro-design-16.meow";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "meow-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "io.github.shiro-design-16.meow.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "meow-backup-dev";
