...
async function resolvePortable() {
  ...
  zip.addLocalFile(path.join(releaseDir, 'MEOW.exe'))
  zip.addLocalFile(path.join(releaseDir, 'meow-mihomo.exe'))
  zip.addLocalFile(path.join(releaseDir, 'meow-mihomo-alpha.exe'))
  ...
  const zipFile = `MEOW_${version}_${arch}_fixed_webview2_portable.zip`
