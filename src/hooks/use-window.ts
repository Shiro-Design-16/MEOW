...
export const useWindowDecorations = () => {
  const { decorated, setDecorations, refreshDecorated } = useWindow()
  return { decorated, setDecorations, refreshDecorated } satisfies Pick<
    WindowContextType,
    'decorated' | 'setDecorations' | 'refreshDecorated'
  >
}
