...
export const translationKeys = [
  ...
  'layout.components.navigation.tabs.extensions',
  ...
  'profiles.page.actions.importFile',
  ...
  'profiles.page.feedback.notifications.fileImported',
  ...
  'rules.page.actions.back',
  'rules.page.tabs.sources',
  'rules.page.tabs.preview',
  'rules.page.preview.description',
  'rules.page.appRouting.title',
  'rules.page.appRouting.highest',
  'rules.page.appRouting.description',
  'rules.page.appRouting.configure',
  'rules.page.sources.title',
  'rules.page.sources.description',
  'rules.page.sources.ruleCount',
  'rules.page.sources.active.locked',
  'rules.page.sources.active.noSubscription',
  'rules.page.sources.status.enabled',
  'rules.page.sources.status.disabled',
  'rules.page.sources.status.invalid',
  'rules.page.sources.actions.open',
  'rules.page.sources.actions.editOverride',
  'rules.page.sources.actions.import',
  'rules.page.sources.actions.create',
  'rules.page.sources.messages.imported',
  'rules.page.sources.messages.created',
  'rules.page.sources.messages.confirmDelete',
  'rules.page.sources.messages.deleted',
  'rules.page.sources.messages.saved',
  'rules.page.sources.create.title',
  'rules.page.sources.create.name',
  'rules.page.sources.editor.visual',
  'rules.page.sources.editor.empty',
  'rules.page.sources.editor.addRule',
  'rules.page.sources.editor.searchPlaceholder',
  'rules.page.sources.editor.allTypes',
  'rules.page.sources.editor.allPolicies',
  'rules.page.sources.editor.type',
  'rules.page.sources.editor.match',
  'rules.page.sources.editor.policy',
  'rules.page.sources.editor.options',
  'rules.page.sources.editor.moveUp',
  'rules.page.sources.editor.moveDown',
  'rules.page.sources.editor.duplicate',
  'rules.page.legacy.title',
  'rules.page.legacy.description',
  ...
  'rules.page.title',
  'rules.extensions.title',
  'rules.extensions.theme.title',
  'rules.extensions.theme.description',
  'rules.extensions.theme.package',
  'rules.extensions.theme.manage',
  'rules.extensions.theme.mode',
  'rules.extensions.theme.modeUnavailable',
  'rules.extensions.theme.modes.light',
  'rules.extensions.theme.modes.dark',
  'rules.extensions.theme.modes.system',
  'rules.extensions.theme.manager.title',
  'rules.extensions.theme.manager.description',
  'rules.extensions.theme.manager.import',
  'rules.extensions.theme.manager.importDialogTitle',
  'rules.extensions.theme.manager.imported',
  'rules.extensions.theme.manager.removed',
  'rules.extensions.theme.manager.confirmRemove',
  ...
  'rules.extensions.theme.manager.active',
  'rules.extensions.theme.manager.builtIn',
  'rules.extensions.theme.manager.local',
  'rules.extensions.theme.manager.remove',
  'rules.extensions.theme.manager.apply',
  'rules.extensions.theme.manager.applied',
  'rules.extensions.theme.manager.onlineTitle',
  'rules.extensions.theme.manager.onlineDescription',
  'rules.extensions.empty.title',
  'rules.extensions.empty.description',
  ...
  'settings.sections.appRouting.title',
  'settings.sections.appRouting.description',
  'settings.sections.appRouting.fields.enabled',
  'settings.sections.appRouting.fields.routes',
  'settings.sections.appRouting.fields.application',
  'settings.sections.appRouting.fields.policy',
  'settings.sections.appRouting.actions.configure',
  'settings.sections.appRouting.actions.add',
  'settings.sections.appRouting.actions.refresh',
  ...
  'settings.sections.appRouting.messages.empty',
  'settings.sections.appRouting.messages.saved',
  'settings.sections.appRouting.messages.duplicateApp',
  'settings.sections.appRouting.messages.policyRequired',
  'settings.sections.appRouting.messages.noMoreApps',
